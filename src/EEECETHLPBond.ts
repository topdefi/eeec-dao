...
import { DepositCall, RedeemCall  } from '../generated/EEECETHLPBond/BondDepository'
import { Deposit } from '../generated/schema'
import { loadOrCreateTransaction } from "./utils/Transactions"
import { loadOrCreateOHMie, updateOhmieBalance } from "./utils/OHMie"
import { toDecimal } from "./utils/Decimals"
import { EEECETHLPBOND_TOKEN, SUSHI_EEECETH_PAIR } from './utils/Constants'
...
export function handleDeposit(call: DepositCall): void {
  ...
  let token = loadOrCreateToken(EEECETHLPBOND_TOKEN)
  ...
  deposit.value = getPairUSD(call.inputs._amount, SUSHI_EEECETH_PAIR)
...
export function handleRedeem(call: RedeemCall): void {
  ...
  redemption.token = loadOrCreateToken(EEECETHLPBOND_TOKEN).id;
