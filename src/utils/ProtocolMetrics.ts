...
function getMV_RFV(transaction: Transaction): BigDecimal[]{
    ...
    let squidethPair = UniswapV2Pair.bind(Address.fromString(SUSHI_EEECETH_PAIR))
    ...
    let squideth_value = getPairUSD(squidethBalance, SUSHI_EEECETH_PAIR)
    let squideth_rfv = getDiscountedPairUSD(squidethBalance, SUSHI_EEECETH_PAIR)
    ...
    log.debug("Treasury EEEC-ETH RFV {}", [squideth_rfv.toString()])
